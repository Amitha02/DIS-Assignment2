    ...
    public class StockList
    {
        ...
        public void SortByValue()
        {
            ...
            if (this.Length() > 0)
            {
                ...
                for (int i = 0; i < this.Length(); i++)
                {
                    ...
                    while (current.Next != null)
                    {
                        //swap the current holdings if it is smaller than the next one
        ...
        public void SortByName()
        {
            ...
            for (int i = 0; i < this.Length(); i++)
            {
                ...
                while (current.Next != null)
                {
                    //compare the stockholding name and swap it if it is alphabetically greater
        ...
        public int Length()
        {
            ...
            //increment length until we reach the end of list
            while (current != null)
            {
                current = current.Next;
                length++;
        ...
        {
            StockNode current = head;
            //Keep printing the current stockholding until we reach the end of list
            while (current != null)
            {
